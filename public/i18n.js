...
const i18n = {
  es: {
    ...
    'winner-pool-sub':       '¡Felicidades! Ganaste el pozo de {0} sats. Crea una factura por {1} sats; {2} sats quedan reservados para fees.',
    'btn-claim-prize':       'Cobrar Premio',
    'payout-title':          '¡RECLAMA TU PREMIO!',
    'payout-subtitle':       'Crea una factura Lightning por este monto exacto',
    'payout-create-exact':   'Factura exacta: {0} sats. Pozo: {1} sats; reserva para fees: {2} sats.',
    ...
    'payout-pool':           'Pozo total: {0} sats',
    'payout-prize':          'Premio pagado: {0} sats',
    'payout-reserve':        'Reserva para fees: {0} sats',
    'payout-fee-sat':        'Fee de red: {0} sats',
    'payout-fee':            'Fee de red: ~{0} sats ({1} msats)',
    'payout-total':          'Total enviado: {0} sats',
    'payout-reserve-left':   'Reserva restante: {0} sats',
  ...
  en: {
    ...
    'winner-pool-sub':       'Congratulations! You won the {0} sats pool. Create an invoice for {1} sats; {2} sats are reserved for fees.',
    'btn-claim-prize':       'Claim Prize',
    'payout-title':          'CLAIM YOUR PRIZE!',
    'payout-subtitle':       'Create a Lightning invoice for this exact amount',
    'payout-create-exact':   'Exact invoice: {0} sats. Pool: {1} sats; fee reserve: {2} sats.',
    ...
    'payout-pool':           'Total pool: {0} sats',
    'payout-prize':          'Prize paid: {0} sats',
    'payout-reserve':        'Fee reserve: {0} sats',
    'payout-fee-sat':        'Network fee: {0} sats',
